...
export class ReviewCardsComponent implements AfterViewInit, OnDestroy {
  ...
  reviews: Review[] = [
    ...
    },
    {
      name: 'Sunita Rao',
      role: 'Teacher',
      avatar: 'assets/review-users/w-8.webp',
      content:
    ...
    },
    {
      name: 'Pooja Desai',
      role: 'Baker',
      avatar: 'assets/review-users/w-9.webp',
      content:
    ...
    },
    {
      name: 'Nitin Batra',
      role: 'Photographer',
      avatar: 'assets/review-users/men-9.webp',
      content:
    ...
    },
    {
      ...
      avatar: 'assets/review-users/w-10.webp',
      content:
    ...
    },
    {
      name: 'Devika Menon',
      role: 'Caregiver',
      avatar: 'assets/review-users/w-11.webp',
      content:
    ...
    },
    {
      name: 'Gaurav Chawla',
      role: 'Tenant',
      avatar: 'assets/review-users/men-11.webp',
      content:
